<form action="<?php echo $url; ?>" method="post">
    ...
    <button type="submit" name="wppv_submit">Submit</button>
    <button type="button" name="wppv_reset" id="wppv-reset" onclick="window.location.href = window.location.href">Reset</button>
</form>
